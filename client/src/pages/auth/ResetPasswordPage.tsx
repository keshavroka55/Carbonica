    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-bg-gradient-start to-bg-gradient-end">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-primary-DEFAULT mb-2">
          ...
          <div className="flex justify-center gap-2">
            <div className="w-2 h-2 bg-accent-DEFAULT rounded-full animate-bounce" style={{ animationDelay: "0s" }} />
            <div className="w-2 h-2 bg-accent-DEFAULT rounded-full animate-bounce" style={{ animationDelay: "0.2s" }} />
            <div className="w-2 h-2 bg-accent-DEFAULT rounded-full animate-bounce" style={{ animationDelay: "0.4s" }} />
          </div>
        </motion.div>
      </div>
    );
            ...
            {error && (
              <div className="mb-4 p-4 rounded-xl bg-red-50 border border-red-200">
                ...
                {error.includes("Invalid or expired") && (
                  <Link to="/forgot-password" className="text-accent-DEFAULT text-sm mt-2 inline-block hover:underline">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 rounded-xl border border-border bg-white text-primary placeholder:text-muted/60 focus:outline-none focus:ring-2 focus:ring-accent-DEFAULT/50 focus:border-transparent transition-all"
